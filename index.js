...
<body>
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            document.querySelectorAll(".grid-item").forEach(item => {
                ...
                // Create background
                const purchaseBg = document.createElement("div");
                purchaseBg.classList.add("purchase-bg");

                // Create button
                const purchaseBtn = document.createElement("button");
                purchaseBtn.classList.add("purchase-btn");
                purchaseBtn.textContent = "Purchase on Battle.net";
                purchaseBtn.addEventListener("click", function() {
                    const skinCode = item.getAttribute("data-code");
                    const url = "https://us.checkout.battle.net/shop/en/checkout/buy/" + skinCode;
                    window.open(url, "_blank");
                });

                // Append elements
                purchaseContainer.appendChild(purchaseBg);
                purchaseContainer.appendChild(purchaseBtn);
                item.appendChild(purchaseContainer);
            });
        });
    ...
    <div class="navbar">
        <div class="logo">
            <img src="https://cdn.owcatalog.de/cdn/assets/ui/owcatalog-logo.webp">
        </div>
        <div class="nav-links">
            <a href="#">
                <img src="https://cdn.owcatalog.de/cdn/assets/ui/home.webp"> <span>Home</span>
            </a>
            <a class="nav-links-selected" href="#">
                <img src="https://cdn.owcatalog.de/cdn/assets/ui/cosmetics.webp"> <span>Cosmetics</span>
            </a>
            <a href="#">
                <img src="https://cdn.owcatalog.de/cdn/assets/ui/bundles.webp"> <span>Bundles</span>
            </a>
        </div>
    </div>
    <div class="content">
        <div class="grid-container">
            ...
            `<div class="grid-item" data-code="${skin.code}">
                <a>
                    <div class="price-tag">
